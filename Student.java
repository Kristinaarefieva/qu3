...
class Frame implements ActionListener
{
    ...
    void mainframe()
    {
        f1=new JFrame("Registration form for passing exams");

        head1=new JLabel("Student's registration for exams");
        head1.setBounds(100, 60, 300, 50);
    ...
    void edit_frame()
    {
        f3=new JFrame("Edit info");

        head3=new JLabel("Edit Profile");
        ...
        lname1=new JLabel("Student's name: ");
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if(s.equals("Register"))
        {
            ...
            {
                lmes.setText("Empty credentials");
            ...
            else
            {
                ...
                if(ob.add_detail()==1)
                {
                    lmes.setText("Successfully registered");
                    lmes.setForeground(Color.GREEN);
                }
                else
                {
                   lmes.setText("Error (check DB conn.)");
                   lmes.setForeground(Color.RED);
                }
            }
        }
        ...
        if(s.equals("Update"))
        {
            ...
            {
                lupdate.setText("Empty credentials");
            ...
            {
                lupdate.setText("Error (check DB conn.)");
                lupdate.setForeground(Color.RED);
            }
        }
        if(s.equals("Delete"))
        {
            ...
            {
                lsuccess.setText("Error (check DB conn.)");
